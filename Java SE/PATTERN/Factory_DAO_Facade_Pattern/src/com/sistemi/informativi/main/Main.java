...
public class Main {
    public static void main(String[] args) {
        ...
        /*
        IL METODO MAIN POTRA' SCEGLIERE UNA VOCE DELL'ENUM
        TRAMITE L'INVOCAZIONE DI UN METODO, ED IN BASE
        ALLA SCELTA IL MAIN RICEVERA' LE INFORMAZIONI DI INTERESSE
         */
